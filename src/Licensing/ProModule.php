<?php
namespace FluentFlow\Licensing;
...
class ProModule implements FeatureInterface {
	...
	public function get_stored_license(): string {
		return AdminDashboard::get_setting( 'license_key', '' );
	}
	...
	public static function require_valid_license(): void {
		$instance = Plugin::instance()->get_module( 'pro' );

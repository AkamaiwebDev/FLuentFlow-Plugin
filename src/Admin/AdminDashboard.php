<?php
namespace FluentFlow\Admin;

use FluentFlow\Core\Plugin;
...
final class AdminDashboard {
	...
	public function render_settings_page(): void {
		...
		require FFBB_DIR . '/includes/views/admin-settings.php';
	}
	...
	public function render_tags_page(): void {
		...
		$token_groups = DataFetcher::get_token_groups();
		require FFBB_DIR . '/includes/views/admin-tags.php';
	}
	...
	public function render_license_page(): void {
		...
		$pro      = Plugin::instance()->get_module( 'pro' );
		$status   = $pro ? $pro->is_licensed() : false;

		require FFBB_DIR . '/includes/views/admin-license.php';
	}
	...
	public function handle_save(): void {
		...
		update_option( TemplateOverridesModule::OVERRIDES_OPTION, $overrides );
	...
	public function handle_license_save(): void {
		...
		delete_transient( ProModule::VALIDATION_TRANSIENT );
